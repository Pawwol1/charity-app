                    ...
                    <form className = "form__contact" onSubmit = {this.handleSubmit}>
                        <div className = "contact__user__data">
                            <div className = "form__data">
                                ...
                                <input type = "text" id = "name" placeholder = "Krzysztof" value ={this.state.name} onChange = {this.handleChange} required/>
                            </div>
                            <div className ="form__data">
                                <label htmlFor = "email">Wpisz swój e-mail</label>
                                <input type = "email" id = "email" placeholder = "abc@xyz.pl" value ={this.state.email} onChange = {this.handleChange} required/>
                            </div>
                        </div>
                        <div className = "form__message">
                            <label htmlFor = "message">Wpisz swoją wiadomość</label>
                            <textarea id = "message" minLength = "120" value ={this.state.message} placeholder = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore." onChange = {this.handleChange} required/>
                        </div>
